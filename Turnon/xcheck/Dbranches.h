...
void setDbranchesaddress(TTree* dnt)
{
  ...
  xjjroot::setbranchaddress(dnt, "Dtrk1PtErr", Dtrk1PtErr);
  xjjroot::setbranchaddress(dnt, "Dtrk2PtErr", Dtrk2PtErr);
  xjjroot::setbranchaddress(dnt, "Dtrk1PixelHit", Dtrk1PixelHit);
  xjjroot::setbranchaddress(dnt, "Dtrk2PixelHit", Dtrk2PixelHit);
  xjjroot::setbranchaddress(dnt, "Dtrk1StripHit", Dtrk1StripHit);
  xjjroot::setbranchaddress(dnt, "Dtrk2StripHit", Dtrk2StripHit);
  xjjroot::setbranchaddress(dnt, "Dtrk1nPixelLayer", Dtrk1nPixelLayer);
  xjjroot::setbranchaddress(dnt, "Dtrk2nPixelLayer", Dtrk2nPixelLayer);
  xjjroot::setbranchaddress(dnt, "Dtrk1nStripLayer", Dtrk1nStripLayer);
  xjjroot::setbranchaddress(dnt, "Dtrk2nStripLayer", Dtrk2nStripLayer);
  xjjroot::setbranchaddress(dnt, "Dtrk1Chi2ndf", Dtrk1Chi2ndf);
  xjjroot::setbranchaddress(dnt, "Dtrk2Chi2ndf", Dtrk2Chi2ndf);
}
